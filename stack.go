...
// For historical compatibility with pkg/errors, Frame is an alias for
...
// file returns the full path to the file that contains the function
// for this Frame's pc.
...
// line returns the line number of source code of the function for
// this Frame's pc.
